...
<script async
    src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAk55aeZXneWoStqbc2CVV7vXWdE4ApRj4&libraries=places&callback=initMap">
</script>
            ...
            let formData = new FormData(this);
                ...
                $.ajax({
                        ...
                        success: (response) => {
                            ...
                            window.location.href = "/customers/location/details";
                        },
