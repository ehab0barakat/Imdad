...
@push('css_or_js')
    <style>
        ...
        #Account , #Locations , #locations, #building , #notifications , #terms_conditions , #terms_conditions, #privacy_police, #Wallet{
        ...
        <div class="row">
            <div class="col-md-8">
                ...
                <div class="wallet-right col-12" style="text-align:right;border:1px solid #E4E9F2;min-height:35rem">
                    ...
                    <form style="width:80%;margin:25px auto" action="{{route('customer.location.updated')}}" method="post"  enctype="multipart/form-data" id="location_updated">
                    @csrf
                        <div class="mb-3">
                            <label for="exampleInputEmail1" class="form-label">{{App\CPU\translate('name')}}</label>
                        ...
                        <div class="mb-3">
                        <label for="exampleInputEmail1" class="form-label">{{App\CPU\translate('building_no')}}</label>
                            <input type="text" name="building_no" class="form-control">
                        </div>

                        <div class="mb-3">floor
                        <label for="exampleInputEmail1" class="form-label">{{App\CPU\translate('building_no')}}</label>
                            <select name="building_floor" id="" class="form-control">
                                ...
                                <option value="الدور الثالث او اعلي">{{App\CPU\translate('Third_Floor_or_More')}}</option>
                              
                            </select>
                        </div>

                        <div class="mb-3">
                        <label for="exampleInputEmail1" class="form-label">{{App\CPU\translate('address_details')}}</label>
                        ...
                        <div class="mb-3">
                        <label for="exampleInputEmail1" class="form-label">{{App\CPU\translate('delivery_contact_no')}}</label>
                            <input type="number"  name="delivery_phone" class="form-control">
                        </div>

                        <div class="mb-3">
                            <label for="formFile" class="form-label">{{App\CPU\translate('building_img')}}</label>
                            <input class="form-control" name="building_image" type="file" id="formFile">
                        </div>

                        <div class="mb-3">
                            <label for="formFile" class="form-label">{{App\CPU\translate('delivery_img')}}</label>
                            <input class="form-control" name="delivery_image" type="file" id="formFile">
                        </div>
                    ...
                    <div id="Account" class="tabcontent">
                        ...
                        <section style="padding:20px;border-bottom:1px solid #E4E9F2;display:flex;justify-content:space-between">
                            <button type="submit" form="customer_account" formaction="{{route('customer.account.update')}}" id="account_submit" class="btn btn-primary" disabled>حفظ التغيرات</button>
                            <h5>حسابي</h5>
                        </section>
                    ...
                    <div id="building" class="tabcontent">
                        <form method="post" action="{{route('customer.building.update')}}" id="customer_buliding_update" style="width:90%;margin:20px auto;direction:rtl">
                            ...
                            <div class="mb-3">
                                <label for="exampleInputPassword1" class="form-label">البريد الالكتروني للمنشاة</label>
