                ...
                <div class="card border-0 box-shadow">
                    <div class="card-body">
                       <img style="height: 80px!important;width:auto;display:block;margin:auto" class="mobile-logo-img"
                         ...
                         alt="emdadb2b"/>
                         <h4 style="text-align:center;padding-top:2rem;font-weight:600">{{App\CPU\translate('yours_phone')}}</h4>
                         <p style="text-align:center;font-weight:600">{{App\CPU\translate('whats_verfiry')}}</p>
