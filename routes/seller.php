...
Route::get('/seller/sales/deferred/report', [ReportsController::class,'seller_deferred_sales_report'])->middleware('seller')->name('seller.deferred.sales.report');
Route::get('/seller/sales/deferred/chart', [ReportsController::class,'seller_sales_deffered_chart'])->middleware('seller')->name('seller.sales.deffered.chart');
