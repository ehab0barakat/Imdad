...
class ReportsController extends Controller
{
    ...
    public function seller_sales() {
        ...
        return view('seller-views.reports.sales', compact('sales_of_month', 'invoices', 'unpaid_invoices', 'sales_of_month_deffered', 'sales_of_month_return'));
    ...
    public function seller_sales_refund() {
        ...
        return view('seller-views.reports.sales_refund', compact('sales_of_month', 'invoices'));
    }
    ...
    public function seller_deferred_sales_report() {
        ...
        return view('seller-views.reports.deferred', compact('sales_of_month', 'invoices'));
    ...
    public function seller_delivery_report() {
        ...
        return view('seller-views.reports.delivery');
