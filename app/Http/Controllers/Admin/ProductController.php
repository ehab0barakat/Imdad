...
class ProductController extends BaseController
{
    ...
    public function admin_products_store(Request $request) {
        ...
        $thumbnailName = time().'.'.$request->product_thumbnail->extension();  
         
        $request->product_thumbnail->move(public_path('product/thumbnail'), $thumbnailName);
    ...
    public function admin_products_update(Request $request) {
        ...
        if ($request->product_image) {
         ...
         if ($request->product_thumbnail) {
            ...
            $request->product_thumbnail->move(public_path('brand/thumbnail/'), $imageName);
